	...
	<section class="main-sec">
		...
		<div style="margin-top: 30px;" class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="box">
					<center>
						<img style="height: 100px;" src="img/good.png">
						<br><br>
						<p>Cieee <em><b>(Nama)</b></em> NRP <b><em>(5215100061)</em></b> , diterima Staff BEM FTIf Semangat Berpadu 2017/2018. Selamat yaa!</p>
					</center>
					</div>
				</div>
			</div>
