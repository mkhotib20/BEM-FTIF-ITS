   ...
   <section id="portfolio-information" class="padding-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="<?php echo base_url('assets/front/images/portfolio-details/1.jpg') ?>" class="img-responsive" alt="">
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="live-preview">
                        <a href="#" class="btn btn-common uppercase">Lihat DI Instagram</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="related-work" class="padding-top padding-bottom">
        <div class="container">
            <div class="row">
                <h1 class="title text-center">Berita Terkait</h1>
                <div class="col-sm-3">
                    <div class="portfolio-wrapper">
                        <div class="portfolio-single">
                            <div class="portfolio-thumb">
                                <img src="<?php echo base_url('assets/front/images/portfolio/1.jpg') ?>" class="img-responsive" alt="">
                            </div>
