...
<head>
	...
	<title>Semangat Berpadu Segera Hadir</title>
	...
	html{
		height:100%;
		background: #ffffff url('<?php echo base_url('assets/bg.jpg') ?>'); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" style="height: 200px" src="<?php echo base_url('assets/icon.png') ?>">
			    				
			<h1 id="cspio-headline">Semangat Berpadu Segera Hadir</h1>			    				
			
			
			<div id="cspio-socialprofiles">
				<a href="https://www.facebook.com/BEM.FTIF.ITS/" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>			
				<a href="https://www.instagram.com/bemftif_its/" target="_blank"><i class="fa fa-instagram fa-2x"></i></a>
				<a href="https://twitter.com/bemftif_its" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>			
			</div>
	...
	<script>
		setTimeout(function(){ jQuery("#cspio-content").show().addClass('animated fadeIn'); }, 10);
